...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, config, options, document, port;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    swagger_1.SwaggerModule.setup(config.get('app.doc'), app, document);
                ...
                case 2:
                    ...
                    console.log(cowsay.say({
                        text: "App is running at ".concat(config.get('app.url'), " | Doc: ").concat(config.get('app.url'), "/").concat(config.get('app.doc'))
                    }));
                    return [2 /*return*/];
            }
        });
